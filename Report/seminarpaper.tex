...
\date{\today \\[7.5cm]
	...
	\begin{minipage}[t]{1.0\linewidth}
		\begin{tabular}{@{}*{2}{p{.5\textwidth}@{}}}
			Duration & 05.09.2016 - 29.05.2017 \\
			Matriculation number & 4305058, 6405724 \\
			Course of studies & Applied Computer Science \\
			Course & TINF14AIBC \\
			Supervising tutor & Prof. Dr. Karl Stroetmann \\
		\end{tabular}
	\end{minipage}
}
